  ...
  const breadcrumbs = showContactForm
    ? [
        ...
        },
        {
          ...
          href: buildLocalizedPath(locale, 'calculate'),
        },
        {
            ...
            <div className={styles.contactFields}>
              <div className={styles.field}>
                ...
                <input
                  id="fullName"
                  name="fullName"
                  className={`${styles.input} ${contactErrors.fullName ? styles.inputError : ''}`}
              ...
              <div className={styles.field}>
                ...
                <input
                  id="phone"
                  name="phone"
                  className={`${styles.input} ${contactErrors.phone ? styles.inputError : ''}`}
