...
type GivataimMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType["givataimMovePage"];
    calculatorDictionary: DictionaryType["homeHero"];
};

export default function GivataimMovePage({
                                             locale,
                                             dictionary,
                                             calculatorDictionary,
                                         }: GivataimMovePageProps) {
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="givataim-title">
                <div className={styles.container}>
                    <h1 id="givataim-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section className={styles.section} id={dictionary.why.id} aria-labelledby="givataim-why">
                <div className={styles.container}>
                    <h2 id="givataim-why" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.pricing.id} aria-labelledby="givataim-pricing">
                <div className={styles.container}>
                    <h2 id="givataim-pricing" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.challenges.id} aria-labelledby="givataim-challenges">
                <div className={styles.container}>
                    <h2 id="givataim-challenges" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.smallMoves.id} aria-labelledby="givataim-small">
                <div className={styles.container}>
                    <h2 id="givataim-small" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.officeMoves.id} aria-labelledby="givataim-office">
                <div className={styles.container}>
                    <h2 id="givataim-office" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.extraServices.id} aria-labelledby="givataim-extra">
                <div className={styles.container}>
                    <h2 id="givataim-extra" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.faq.id} aria-labelledby="givataim-faq">
                <div className={styles.container}>
                    <h2 id="givataim-faq" className={styles.sectionTitle}>
