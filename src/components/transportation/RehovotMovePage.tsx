...
type RehovotMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType["rehovotMovePage"];
    calculatorDictionary: DictionaryType["homeHero"];
};

export default function RehovotMovePage({
                                            locale,
                                            dictionary,
                                            calculatorDictionary,
                                        }: RehovotMovePageProps) {
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="rehovot-title">
                <div className={styles.container}>
                    <h1 id="rehovot-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section className={styles.section} id={dictionary.why.id} aria-labelledby="rehovot-why">
                <div className={styles.container}>
                    <h2 id="rehovot-why" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.pricing.id} aria-labelledby="rehovot-pricing">
                <div className={styles.container}>
                    <h2 id="rehovot-pricing" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.challenges.id} aria-labelledby="rehovot-challenges">
                <div className={styles.container}>
                    <h2 id="rehovot-challenges" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.smallMoves.id} aria-labelledby="rehovot-small">
                <div className={styles.container}>
                    <h2 id="rehovot-small" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.officeMoves.id} aria-labelledby="rehovot-office">
                <div className={styles.container}>
                    <h2 id="rehovot-office" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.extraServices.id} aria-labelledby="rehovot-extra">
                <div className={styles.container}>
                    <h2 id="rehovot-extra" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.faq.id} aria-labelledby="rehovot-faq">
                <div className={styles.container}>
                    <h2 id="rehovot-faq" className={styles.sectionTitle}>
