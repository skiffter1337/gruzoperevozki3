...
type BeitShemeshMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType["beitShemeshMovePage"];
    calculatorDictionary: DictionaryType["homeHero"];
};

export default function BeitShemeshMovePage({
                                                locale,
                                                dictionary,
                                                calculatorDictionary,
                                            }: BeitShemeshMovePageProps) {
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="beit-shemesh-title">
                <div className={styles.container}>
                    <h1 id="beit-shemesh-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section
                ...
                aria-labelledby="beit-shemesh-why"
            >
                <div className={styles.container}>
                    <h2 id="beit-shemesh-why" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="beit-shemesh-pricing"
            >
                <div className={styles.container}>
                    <h2 id="beit-shemesh-pricing" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="beit-shemesh-challenges"
            >
                <div className={styles.container}>
                    <h2 id="beit-shemesh-challenges" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="beit-shemesh-small"
            >
                <div className={styles.container}>
                    <h2 id="beit-shemesh-small" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="beit-shemesh-office"
            >
                <div className={styles.container}>
                    <h2 id="beit-shemesh-office" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="beit-shemesh-extra"
            >
                <div className={styles.container}>
                    <h2 id="beit-shemesh-extra" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="beit-shemesh-faq"
            >
                <div className={styles.container}>
                    <h2 id="beit-shemesh-faq" className={styles.sectionTitle}>
