...
export default function MevaseretZionMovePage({
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="mevaseret-zion-title">
                <div className={styles.container}>
                    <h1 id="mevaseret-zion-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section
                ...
                aria-labelledby="mevaseret-zion-why"
            >
                <div className={styles.container}>
                    <h2 id="mevaseret-zion-why" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="mevaseret-zion-pricing"
            >
                <div className={styles.container}>
                    <h2 id="mevaseret-zion-pricing" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="mevaseret-zion-challenges"
            >
                <div className={styles.container}>
                    <h2 id="mevaseret-zion-challenges" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="mevaseret-zion-small"
            >
                <div className={styles.container}>
                    <h2 id="mevaseret-zion-small" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="mevaseret-zion-office"
            >
                <div className={styles.container}>
                    <h2 id="mevaseret-zion-office" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="mevaseret-zion-extra"
            >
                <div className={styles.container}>
                    <h2 id="mevaseret-zion-extra" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="mevaseret-zion-faq"
            >
                <div className={styles.container}>
                    <h2 id="mevaseret-zion-faq" className={styles.sectionTitle}>
