...
type EilatMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType["eilatMovePage"];
    calculatorDictionary: DictionaryType["homeHero"];
};

export default function EilatMovePage({
                                          locale,
                                          dictionary,
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="eilat-title">
                <div className={styles.container}>
                    <h1 id="eilat-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section
                ...
                aria-labelledby="eilat-why"
            >
                <div className={styles.container}>
                    <h2 id="eilat-why" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="eilat-pricing"
            >
                <div className={styles.container}>
                    <h2 id="eilat-pricing" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="eilat-challenges"
            >
                <div className={styles.container}>
                    <h2 id="eilat-challenges" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="eilat-small"
            >
                <div className={styles.container}>
                    <h2 id="eilat-small" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="eilat-office"
            >
                <div className={styles.container}>
                    <h2 id="eilat-office" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="eilat-extra"
            >
                <div className={styles.container}>
                    <h2 id="eilat-extra" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="eilat-faq"
            >
                <div className={styles.container}>
                    <h2 id="eilat-faq" className={styles.sectionTitle}>
