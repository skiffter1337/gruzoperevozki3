...
type BeerShevaMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType["beerShevaMovePage"];
    calculatorDictionary: DictionaryType["homeHero"];
};

export default function BeerShevaMovePage({
                                              locale,
                                              dictionary,
                                              calculatorDictionary,
                                          }: BeerShevaMovePageProps) {
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="beer-sheva-title">
                <div className={styles.container}>
                    <h1 id="beer-sheva-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section
                ...
                aria-labelledby="beer-sheva-why"
            >
                <div className={styles.container}>
                    <h2 id="beer-sheva-why" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="beer-sheva-pricing"
            >
                <div className={styles.container}>
                    <h2 id="beer-sheva-pricing" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="beer-sheva-challenges"
            >
                <div className={styles.container}>
                    <h2 id="beer-sheva-challenges" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="beer-sheva-small"
            >
                <div className={styles.container}>
                    <h2 id="beer-sheva-small" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="beer-sheva-office"
            >
                <div className={styles.container}>
                    <h2 id="beer-sheva-office" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="beer-sheva-extra"
            >
                <div className={styles.container}>
                    <h2 id="beer-sheva-extra" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="beer-sheva-faq"
            >
                <div className={styles.container}>
                    <h2 id="beer-sheva-faq" className={styles.sectionTitle}>
