...
type JerusalemMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType["jerusalemMovePage"];
    calculatorDictionary: DictionaryType["homeHero"];
};

export default function JerusalemMovePage({
                                              locale,
                                              dictionary,
                                              calculatorDictionary,
                                          }: JerusalemMovePageProps) {
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="jerusalem-title">
                <div className={styles.container}>
                    <h1 id="jerusalem-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section className={styles.section} id={dictionary.why.id} aria-labelledby="jerusalem-why">
                <div className={styles.container}>
                    <h2 id="jerusalem-why" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.pricing.id} aria-labelledby="jerusalem-pricing">
                <div className={styles.container}>
                    <h2 id="jerusalem-pricing" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.challenges.id} aria-labelledby="jerusalem-challenges">
                <div className={styles.container}>
                    <h2 id="jerusalem-challenges" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.smallMoves.id} aria-labelledby="jerusalem-small">
                <div className={styles.container}>
                    <h2 id="jerusalem-small" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.officeMoves.id} aria-labelledby="jerusalem-office">
                <div className={styles.container}>
                    <h2 id="jerusalem-office" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.extraServices.id} aria-labelledby="jerusalem-extra">
                <div className={styles.container}>
                    <h2 id="jerusalem-extra" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.faq.id} aria-labelledby="jerusalem-faq">
                <div className={styles.container}>
                    <h2 id="jerusalem-faq" className={styles.sectionTitle}>
