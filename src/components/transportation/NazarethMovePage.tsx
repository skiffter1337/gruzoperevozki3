...
type NazarethMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType["nazarethMovePage"];
    calculatorDictionary: DictionaryType["homeHero"];
};

export default function NazarethMovePage({
                                             locale,
                                             dictionary,
                                             calculatorDictionary,
                                         }: NazarethMovePageProps) {
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="nazareth-title">
                <div className={styles.container}>
                    <h1 id="nazareth-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section
                ...
                aria-labelledby="nazareth-why"
            >
                <div className={styles.container}>
                    <h2 id="nazareth-why" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="nazareth-pricing"
            >
                <div className={styles.container}>
                    <h2 id="nazareth-pricing" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="nazareth-challenges"
            >
                <div className={styles.container}>
                    <h2 id="nazareth-challenges" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="nazareth-small"
            >
                <div className={styles.container}>
                    <h2 id="nazareth-small" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="nazareth-office"
            >
                <div className={styles.container}>
                    <h2 id="nazareth-office" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="nazareth-extra"
            >
                <div className={styles.container}>
                    <h2 id="nazareth-extra" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="nazareth-faq"
            >
                <div className={styles.container}>
                    <h2 id="nazareth-faq" className={styles.sectionTitle}>
