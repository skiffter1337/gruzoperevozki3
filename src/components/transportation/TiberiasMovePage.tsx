...
export default function TiberiasMovePage({
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="tiberias-title">
                <div className={styles.container}>
                    <h1 id="tiberias-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section
                ...
                aria-labelledby="tiberias-why"
            >
                <div className={styles.container}>
                    <h2 id="tiberias-why" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="tiberias-pricing"
            >
                <div className={styles.container}>
                    <h2 id="tiberias-pricing" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="tiberias-challenges"
            >
                <div className={styles.container}>
                    <h2 id="tiberias-challenges" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="tiberias-small"
            >
                <div className={styles.container}>
                    <h2 id="tiberias-small" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="tiberias-office"
            >
                <div className={styles.container}>
                    <h2 id="tiberias-office" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="tiberias-extra"
            >
                <div className={styles.container}>
                    <h2 id="tiberias-extra" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="tiberias-faq"
            >
                <div className={styles.container}>
                    <h2 id="tiberias-faq" className={styles.sectionTitle}>
