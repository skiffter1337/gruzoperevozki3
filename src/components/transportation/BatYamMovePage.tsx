...
type BatYamMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType["batYamMovePage"];
    calculatorDictionary: DictionaryType["homeHero"];
};

export default function BatYamMovePage({
                                           locale,
                                           dictionary,
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="bat-yam-title">
                <div className={styles.container}>
                    <h1 id="bat-yam-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section className={styles.section} id={dictionary.why.id} aria-labelledby="bat-yam-why">
                <div className={styles.container}>
                    <h2 id="bat-yam-why" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.pricing.id} aria-labelledby="bat-yam-pricing">
                <div className={styles.container}>
                    <h2 id="bat-yam-pricing" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.challenges.id} aria-labelledby="bat-yam-challenges">
                <div className={styles.container}>
                    <h2 id="bat-yam-challenges" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.smallMoves.id} aria-labelledby="bat-yam-small">
                <div className={styles.container}>
                    <h2 id="bat-yam-small" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.officeMoves.id} aria-labelledby="bat-yam-office">
                <div className={styles.container}>
                    <h2 id="bat-yam-office" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.extraServices.id} aria-labelledby="bat-yam-extra">
                <div className={styles.container}>
                    <h2 id="bat-yam-extra" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.faq.id} aria-labelledby="bat-yam-faq">
                <div className={styles.container}>
                    <h2 id="bat-yam-faq" className={styles.sectionTitle}>
