...
type HodHaSharonMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType["hodHaSharonMovePage"];
    calculatorDictionary: DictionaryType["homeHero"];
};

export default function HodHaSharonMovePage({
                                                locale,
                                                dictionary,
                                                calculatorDictionary,
                                            }: HodHaSharonMovePageProps) {
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="hod-ha-sharon-title">
                <div className={styles.container}>
                    <h1 id="hod-ha-sharon-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section
                ...
                aria-labelledby="hod-ha-sharon-why"
            >
                <div className={styles.container}>
                    <h2 id="hod-ha-sharon-why" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="hod-ha-sharon-pricing"
            >
                <div className={styles.container}>
                    <h2 id="hod-ha-sharon-pricing" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="hod-ha-sharon-challenges"
            >
                <div className={styles.container}>
                    <h2 id="hod-ha-sharon-challenges" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="hod-ha-sharon-small"
            >
                <div className={styles.container}>
                    <h2 id="hod-ha-sharon-small" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="hod-ha-sharon-office"
            >
                <div className={styles.container}>
                    <h2 id="hod-ha-sharon-office" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="hod-ha-sharon-extra"
            >
                <div className={styles.container}>
                    <h2 id="hod-ha-sharon-extra" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="hod-ha-sharon-faq"
            >
                <div className={styles.container}>
                    <h2 id="hod-ha-sharon-faq" className={styles.sectionTitle}>
