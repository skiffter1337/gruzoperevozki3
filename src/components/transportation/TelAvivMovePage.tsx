...
type TelAvivMovePageProps = {
  locale: Locale;
  dictionary: DictionaryType['telAvivMovePage'];
  calculatorDictionary: DictionaryType['homeHero'];
};

export default function TelAvivMovePage({
  locale,
  dictionary,
  calculatorDictionary,
}: TelAvivMovePageProps) {
  ...
  return (
    <div className={styles.page} dir={isRtl ? 'rtl' : 'ltr'}>
      ...
      <section className={styles.hero} aria-labelledby="tel-aviv-title">
        <div className={styles.container}>
          <h1 id="tel-aviv-title" className={styles.title}>
            {dictionary.title}
          </h1>
      ...
      <section className={styles.section} id={dictionary.why.id} aria-labelledby="tel-aviv-why">
        <div className={styles.container}>
          <h2 id="tel-aviv-why" className={styles.sectionTitle}>
      ...
      <section className={styles.section} id={dictionary.pricing.id} aria-labelledby="tel-aviv-pricing">
        <div className={styles.container}>
          <h2 id="tel-aviv-pricing" className={styles.sectionTitle}>
      ...
      <section className={styles.section} id={dictionary.challenges.id} aria-labelledby="tel-aviv-challenges">
        <div className={styles.container}>
          <h2 id="tel-aviv-challenges" className={styles.sectionTitle}>
      ...
      <section className={styles.section} id={dictionary.smallMoves.id} aria-labelledby="tel-aviv-small">
        <div className={styles.container}>
          <h2 id="tel-aviv-small" className={styles.sectionTitle}>
      ...
      <section className={styles.section} id={dictionary.officeMoves.id} aria-labelledby="tel-aviv-office">
        <div className={styles.container}>
          <h2 id="tel-aviv-office" className={styles.sectionTitle}>
      ...
      <section className={styles.section} id={dictionary.extraServices.id} aria-labelledby="tel-aviv-extra">
        <div className={styles.container}>
          <h2 id="tel-aviv-extra" className={styles.sectionTitle}>
      ...
      <section className={styles.section} id={dictionary.faq.id} aria-labelledby="tel-aviv-faq">
        <div className={styles.container}>
          <h2 id="tel-aviv-faq" className={styles.sectionTitle}>
