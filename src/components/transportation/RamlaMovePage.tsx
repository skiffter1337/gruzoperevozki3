...
export default function RamlaMovePage({
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="ramla-title">
                <div className={styles.container}>
                    <h1 id="ramla-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section
                ...
                aria-labelledby="ramla-why"
            >
                <div className={styles.container}>
                    <h2 id="ramla-why" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="ramla-pricing"
            >
                <div className={styles.container}>
                    <h2 id="ramla-pricing" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="ramla-challenges"
            >
                <div className={styles.container}>
                    <h2 id="ramla-challenges" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="ramla-small"
            >
                <div className={styles.container}>
                    <h2 id="ramla-small" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="ramla-office"
            >
                <div className={styles.container}>
                    <h2 id="ramla-office" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="ramla-extra"
            >
                <div className={styles.container}>
                    <h2 id="ramla-extra" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="ramla-faq"
            >
                <div className={styles.container}>
                    <h2 id="ramla-faq" className={styles.sectionTitle}>
