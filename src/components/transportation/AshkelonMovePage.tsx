...
type AshkelonMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType["ashkelonMovePage"];
    calculatorDictionary: DictionaryType["homeHero"];
};

export default function AshkelonMovePage({
                                             locale,
                                             dictionary,
                                             calculatorDictionary,
                                         }: AshkelonMovePageProps) {
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="ashkelon-title">
                <div className={styles.container}>
                    <h1 id="ashkelon-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section
                ...
                aria-labelledby="ashkelon-why"
            >
                <div className={styles.container}>
                    <h2 id="ashkelon-why" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="ashkelon-pricing"
            >
                <div className={styles.container}>
                    <h2 id="ashkelon-pricing" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="ashkelon-challenges"
            >
                <div className={styles.container}>
                    <h2 id="ashkelon-challenges" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="ashkelon-small"
            >
                <div className={styles.container}>
                    <h2 id="ashkelon-small" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="ashkelon-office"
            >
                <div className={styles.container}>
                    <h2 id="ashkelon-office" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="ashkelon-extra"
            >
                <div className={styles.container}>
                    <h2 id="ashkelon-extra" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="ashkelon-faq"
            >
                <div className={styles.container}>
                    <h2 id="ashkelon-faq" className={styles.sectionTitle}>
