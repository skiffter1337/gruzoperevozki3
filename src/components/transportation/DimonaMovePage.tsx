...
type DimonaMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType["dimonaMovePage"];
    calculatorDictionary: DictionaryType["homeHero"];
};

export default function DimonaMovePage({
                                           locale,
                                           dictionary,
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="dimona-title">
                <div className={styles.container}>
                    <h1 id="dimona-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section
                ...
                aria-labelledby="dimona-why"
            >
                <div className={styles.container}>
                    <h2 id="dimona-why" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="dimona-pricing"
            >
                <div className={styles.container}>
                    <h2 id="dimona-pricing" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="dimona-challenges"
            >
                <div className={styles.container}>
                    <h2 id="dimona-challenges" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="dimona-small"
            >
                <div className={styles.container}>
                    <h2 id="dimona-small" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="dimona-office"
            >
                <div className={styles.container}>
                    <h2 id="dimona-office" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="dimona-extra"
            >
                <div className={styles.container}>
                    <h2 id="dimona-extra" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="dimona-faq"
            >
                <div className={styles.container}>
                    <h2 id="dimona-faq" className={styles.sectionTitle}>
