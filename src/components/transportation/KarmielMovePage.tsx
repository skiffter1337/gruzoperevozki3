...
export default function KarmielMovePage({
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="karmiel-title">
                <div className={styles.container}>
                    <h1 id="karmiel-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section
                ...
                aria-labelledby="karmiel-why"
            >
                <div className={styles.container}>
                    <h2 id="karmiel-why" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="karmiel-pricing"
            >
                <div className={styles.container}>
                    <h2 id="karmiel-pricing" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="karmiel-challenges"
            >
                <div className={styles.container}>
                    <h2 id="karmiel-challenges" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="karmiel-small"
            >
                <div className={styles.container}>
                    <h2 id="karmiel-small" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="karmiel-office"
            >
                <div className={styles.container}>
                    <h2 id="karmiel-office" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="karmiel-extra"
            >
                <div className={styles.container}>
                    <h2 id="karmiel-extra" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="karmiel-faq"
            >
                <div className={styles.container}>
                    <h2 id="karmiel-faq" className={styles.sectionTitle}>
