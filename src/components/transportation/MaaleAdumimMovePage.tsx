...
export default function MaaleAdumimMovePage({
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="maale-adumim-title">
                <div className={styles.container}>
                    <h1 id="maale-adumim-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section
                ...
                aria-labelledby="maale-adumim-why"
            >
                <div className={styles.container}>
                    <h2 id="maale-adumim-why" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="maale-adumim-pricing"
            >
                <div className={styles.container}>
                    <h2 id="maale-adumim-pricing" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="maale-adumim-challenges"
            >
                <div className={styles.container}>
                    <h2 id="maale-adumim-challenges" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="maale-adumim-small"
            >
                <div className={styles.container}>
                    <h2 id="maale-adumim-small" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="maale-adumim-office"
            >
                <div className={styles.container}>
                    <h2 id="maale-adumim-office" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="maale-adumim-extra"
            >
                <div className={styles.container}>
                    <h2 id="maale-adumim-extra" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="maale-adumim-faq"
            >
                <div className={styles.container}>
                    <h2 id="maale-adumim-faq" className={styles.sectionTitle}>
