...
type NetivotMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType["netivotMovePage"];
    calculatorDictionary: DictionaryType["homeHero"];
};

export default function NetivotMovePage({
                                            locale,
                                            dictionary,
                                            calculatorDictionary,
                                        }: NetivotMovePageProps) {
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="netivot-title">
                <div className={styles.container}>
                    <h1 id="netivot-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section
                ...
                aria-labelledby="netivot-why"
            >
                <div className={styles.container}>
                    <h2 id="netivot-why" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="netivot-pricing"
            >
                <div className={styles.container}>
                    <h2 id="netivot-pricing" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="netivot-challenges"
            >
                <div className={styles.container}>
                    <h2 id="netivot-challenges" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="netivot-small"
            >
                <div className={styles.container}>
                    <h2 id="netivot-small" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="netivot-office"
            >
                <div className={styles.container}>
                    <h2 id="netivot-office" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="netivot-extra"
            >
                <div className={styles.container}>
                    <h2 id="netivot-extra" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="netivot-faq"
            >
                <div className={styles.container}>
                    <h2 id="netivot-faq" className={styles.sectionTitle}>
