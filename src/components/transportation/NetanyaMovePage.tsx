...
type NetanyaMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType["netanyaMovePage"];
    calculatorDictionary: DictionaryType["homeHero"];
};

export default function NetanyaMovePage({
                                            locale,
                                            dictionary,
                                            calculatorDictionary,
                                        }: NetanyaMovePageProps) {
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="netanya-title">
                <div className={styles.container}>
                    <h1 id="netanya-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section
                ...
                aria-labelledby="netanya-why"
            >
                <div className={styles.container}>
                    <h2 id="netanya-why" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="netanya-pricing"
            >
                <div className={styles.container}>
                    <h2 id="netanya-pricing" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="netanya-challenges"
            >
                <div className={styles.container}>
                    <h2 id="netanya-challenges" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="netanya-small"
            >
                <div className={styles.container}>
                    <h2 id="netanya-small" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="netanya-office"
            >
                <div className={styles.container}>
                    <h2 id="netanya-office" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="netanya-extra"
            >
                <div className={styles.container}>
                    <h2 id="netanya-extra" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="netanya-faq"
            >
                <div className={styles.container}>
                    <h2 id="netanya-faq" className={styles.sectionTitle}>
