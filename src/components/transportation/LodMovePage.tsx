...
type LodMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType["lodMovePage"];
    calculatorDictionary: DictionaryType["homeHero"];
};

export default function LodMovePage({
                                        locale,
                                        dictionary,
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="lod-title">
                <div className={styles.container}>
                    <h1 id="lod-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section
                ...
                aria-labelledby="lod-why"
            >
                <div className={styles.container}>
                    <h2 id="lod-why" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="lod-pricing"
            >
                <div className={styles.container}>
                    <h2 id="lod-pricing" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="lod-challenges"
            >
                <div className={styles.container}>
                    <h2 id="lod-challenges" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="lod-small"
            >
                <div className={styles.container}>
                    <h2 id="lod-small" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="lod-office"
            >
                <div className={styles.container}>
                    <h2 id="lod-office" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="lod-extra"
            >
                <div className={styles.container}>
                    <h2 id="lod-extra" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="lod-faq"
            >
                <div className={styles.container}>
                    <h2 id="lod-faq" className={styles.sectionTitle}>
