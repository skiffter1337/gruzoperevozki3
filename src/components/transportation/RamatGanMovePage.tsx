...
type RamatGanMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType["ramatGanMovePage"];
    calculatorDictionary: DictionaryType["homeHero"];
};

export default function RamatGanMovePage({
                                             locale,
                                             dictionary,
                                             calculatorDictionary,
                                         }: RamatGanMovePageProps) {
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="city-move-title">
                <div className={styles.container}>
                    <h1 id="city-move-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section
                ...
                aria-labelledby="city-move-why"
            >
                <div className={styles.container}>
                    <h2 id="city-move-why" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="city-move-pricing"
            >
                <div className={styles.container}>
                    <h2 id="city-move-pricing" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="city-move-challenges"
            >
                <div className={styles.container}>
                    <h2 id="city-move-challenges" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="city-move-small"
            >
                <div className={styles.container}>
                    <h2 id="city-move-small" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="city-move-office"
            >
                <div className={styles.container}>
                    <h2 id="city-move-office" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="city-move-extra"
            >
                <div className={styles.container}>
                    <h2 id="city-move-extra" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="city-move-faq"
            >
                <div className={styles.container}>
                    <h2 id="city-move-faq" className={styles.sectionTitle}>
