...
type KfarSabaMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType["kfarSabaMovePage"];
    calculatorDictionary: DictionaryType["homeHero"];
};

export default function KfarSabaMovePage({
                                             locale,
                                             dictionary,
                                             calculatorDictionary,
                                         }: KfarSabaMovePageProps) {
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="kfar-saba-title">
                <div className={styles.container}>
                    <h1 id="kfar-saba-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section className={styles.section} id={dictionary.why.id} aria-labelledby="kfar-saba-why">
                <div className={styles.container}>
                    <h2 id="kfar-saba-why" className={styles.sectionTitle}>
                        {dictionary.why.title}
                    </h2>

                    {dictionary.why.paragraphs.map((p) => (
                        <p key={p} className={styles.paragraph}>{p}</p>
                    ))}

                    <p className={styles.paragraph}>{dictionary.why.bulletsTitle}</p>
                    <ul className={styles.bulletList}>
                        {dictionary.why.bullets.map((b) => (
                            <li key={b}>{b}</li>
                        ))}
                    </ul>
            ...
            <section className={styles.section} id={dictionary.pricing.id} aria-labelledby="kfar-saba-pricing">
                <div className={styles.container}>
                    <h2 id="kfar-saba-pricing" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.challenges.id} aria-labelledby="kfar-saba-challenges">
                <div className={styles.container}>
                    <h2 id="kfar-saba-challenges" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.smallMoves.id} aria-labelledby="kfar-saba-small">
                <div className={styles.container}>
                    <h2 id="kfar-saba-small" className={styles.sectionTitle}>
                        {dictionary.smallMoves.title}
                    </h2>
                    <p className={styles.paragraph}>{dictionary.smallMoves.intro}</p>
                    <ul className={styles.bulletList}>
                        {dictionary.smallMoves.bullets.map((b) => (
                            <li key={b}>{b}</li>
                        ))}
                    </ul>
                </div>
            ...
            <section className={styles.section} id={dictionary.officeMoves.id} aria-labelledby="kfar-saba-office">
                <div className={styles.container}>
                    <h2 id="kfar-saba-office" className={styles.sectionTitle}>
                        {dictionary.officeMoves.title}
                    </h2>
                    <p className={styles.paragraph}>{dictionary.officeMoves.intro}</p>
                    <ul className={styles.bulletList}>
                        {dictionary.officeMoves.bullets.map((b) => (
                            <li key={b}>{b}</li>
                        ))}
                    </ul>
                </div>
            ...
            <section className={styles.section} id={dictionary.extraServices.id} aria-labelledby="kfar-saba-extra">
                <div className={styles.container}>
                    <h2 id="kfar-saba-extra" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.faq.id} aria-labelledby="kfar-saba-faq">
                <div className={styles.container}>
                    <h2 id="kfar-saba-faq" className={styles.sectionTitle}>
