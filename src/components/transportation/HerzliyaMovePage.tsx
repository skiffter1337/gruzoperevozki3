...
type HerzliyaMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType["herzliyaMovePage"];
    calculatorDictionary: DictionaryType["homeHero"];
};

export default function HerzliyaMovePage({
                                             locale,
                                             dictionary,
                                             calculatorDictionary,
                                         }: HerzliyaMovePageProps) {
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="herzliya-title">
                <div className={styles.container}>
                    <h1 id="herzliya-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section
                ...
                aria-labelledby="herzliya-why"
            >
                <div className={styles.container}>
                    <h2 id="herzliya-why" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="herzliya-pricing"
            >
                <div className={styles.container}>
                    <h2 id="herzliya-pricing" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="herzliya-challenges"
            >
                <div className={styles.container}>
                    <h2 id="herzliya-challenges" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="herzliya-small"
            >
                <div className={styles.container}>
                    <h2 id="herzliya-small" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="herzliya-office"
            >
                <div className={styles.container}>
                    <h2 id="herzliya-office" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="herzliya-extra"
            >
                <div className={styles.container}>
                    <h2 id="herzliya-extra" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="herzliya-faq"
            >
                <div className={styles.container}>
                    <h2 id="herzliya-faq" className={styles.sectionTitle}>
