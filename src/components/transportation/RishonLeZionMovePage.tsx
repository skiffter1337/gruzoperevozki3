...
type RishonLeZionMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType["rishonLeZionMovePage"];
    calculatorDictionary: DictionaryType["homeHero"];
};

export default function RishonLeZionMovePage({
                                                 locale,
                                                 dictionary,
                                                 calculatorDictionary,
                                             }: RishonLeZionMovePageProps) {
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="rishon-lezion-title">
                <div className={styles.container}>
                    <h1 id="rishon-lezion-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section className={styles.section} id={dictionary.why.id} aria-labelledby="rishon-lezion-why">
                <div className={styles.container}>
                    <h2 id="rishon-lezion-why" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.pricing.id} aria-labelledby="rishon-lezion-pricing">
                <div className={styles.container}>
                    <h2 id="rishon-lezion-pricing" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.challenges.id} aria-labelledby="rishon-lezion-challenges">
                <div className={styles.container}>
                    <h2 id="rishon-lezion-challenges" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.smallMoves.id} aria-labelledby="rishon-lezion-small">
                <div className={styles.container}>
                    <h2 id="rishon-lezion-small" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.officeMoves.id} aria-labelledby="rishon-lezion-office">
                <div className={styles.container}>
                    <h2 id="rishon-lezion-office" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.extraServices.id} aria-labelledby="rishon-lezion-extra">
                <div className={styles.container}>
                    <h2 id="rishon-lezion-extra" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.faq.id} aria-labelledby="rishon-lezion-faq">
                <div className={styles.container}>
                    <h2 id="rishon-lezion-faq" className={styles.sectionTitle}>
