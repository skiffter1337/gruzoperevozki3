...
type AshdodMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType["ashdodMovePage"];
    calculatorDictionary: DictionaryType["homeHero"];
};

export default function AshdodMovePage({
                                           locale,
                                           dictionary,
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="ashdod-title">
                <div className={styles.container}>
                    <h1 id="ashdod-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section
                ...
                aria-labelledby="ashdod-why"
            >
                <div className={styles.container}>
                    <h2 id="ashdod-why" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="ashdod-pricing"
            >
                <div className={styles.container}>
                    <h2 id="ashdod-pricing" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="ashdod-challenges"
            >
                <div className={styles.container}>
                    <h2 id="ashdod-challenges" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="ashdod-small"
            >
                <div className={styles.container}>
                    <h2 id="ashdod-small" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="ashdod-office"
            >
                <div className={styles.container}>
                    <h2 id="ashdod-office" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="ashdod-extra"
            >
                <div className={styles.container}>
                    <h2 id="ashdod-extra" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="ashdod-faq"
            >
                <div className={styles.container}>
                    <h2 id="ashdod-faq" className={styles.sectionTitle}>
