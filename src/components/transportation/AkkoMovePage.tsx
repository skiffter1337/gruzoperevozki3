...
type AkkoMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType["akkoMovePage"];
    calculatorDictionary: DictionaryType["homeHero"];
};

export default function AkkoMovePage({
                                         locale,
                                         dictionary,
    ...
    return (
        <div className={styles.page} dir={isRtl ? "rtl" : "ltr"}>
            ...
            <section className={styles.hero} aria-labelledby="akko-title">
                <div className={styles.container}>
                    <h1 id="akko-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section
                ...
                aria-labelledby="akko-why"
            >
                <div className={styles.container}>
                    <h2 id="akko-why" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="akko-pricing"
            >
                <div className={styles.container}>
                    <h2 id="akko-pricing" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="akko-challenges"
            >
                <div className={styles.container}>
                    <h2 id="akko-challenges" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="akko-small"
            >
                <div className={styles.container}>
                    <h2 id="akko-small" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="akko-office"
            >
                <div className={styles.container}>
                    <h2 id="akko-office" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="akko-extra"
            >
                <div className={styles.container}>
                    <h2 id="akko-extra" className={styles.sectionTitle}>
            ...
            <section
                ...
                aria-labelledby="akko-faq"
            >
                <div className={styles.container}>
                    <h2 id="akko-faq" className={styles.sectionTitle}>
