...
type HolonMovePageProps = {
    locale: Locale;
    dictionary: DictionaryType['holonMovePage'];
    calculatorDictionary: DictionaryType['homeHero'];
};

export default function HolonMovePage({
                                          locale,
                                          dictionary,
    ...
    return (
        <div className={styles.page} dir={isRtl ? 'rtl' : 'ltr'}>
            ...
            <section className={styles.hero} aria-labelledby="holon-title">
                <div className={styles.container}>
                    <h1 id="holon-title" className={styles.title}>
                        {dictionary.title}
                    </h1>
            ...
            <section className={styles.section} id={dictionary.why.id} aria-labelledby="holon-why">
                <div className={styles.container}>
                    <h2 id="holon-why" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.pricing.id} aria-labelledby="holon-pricing">
                <div className={styles.container}>
                    <h2 id="holon-pricing" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.challenges.id} aria-labelledby="holon-challenges">
                <div className={styles.container}>
                    <h2 id="holon-challenges" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.smallMoves.id} aria-labelledby="holon-small">
                <div className={styles.container}>
                    <h2 id="holon-small" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.officeMoves.id} aria-labelledby="holon-office">
                <div className={styles.container}>
                    <h2 id="holon-office" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.extraServices.id} aria-labelledby="holon-extra">
                <div className={styles.container}>
                    <h2 id="holon-extra" className={styles.sectionTitle}>
            ...
            <section className={styles.section} id={dictionary.faq.id} aria-labelledby="holon-faq">
                <div className={styles.container}>
                    <h2 id="holon-faq" className={styles.sectionTitle}>
