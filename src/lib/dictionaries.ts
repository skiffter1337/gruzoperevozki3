...
const defaultDictionary: DictionaryType = {
    ...
    homeHero: {
        ...
        submit: "Продолжить",
        submitLabel: "Получить предложения с ценами",
    ...
    houseMovePage: {
        slug: 'private-house',
        metaTitle: 'Private Home Moving',
        metaDescription: 'Private Home Moving description.',
        title: 'Private Home Moving',
        tocTitle: 'Table of contents',
        tocItems: [],
        comparison: {
            id: 'why-compare',
            title: 'Why compare private home moving?',
            paragraphs: [],
            bullets: [],
        },
        process: {
        ...
        pricing: {
            id: 'pricing',
            title: 'Private Home Moving pricing',
            intro: '',
            note: '',
            tableLabel: 'Private Home Moving pricing',
            tableHeaders: [],
            rows: [],
            afterTable: '',
        },
    ...
    telAvivMovePage: {
        ...
        pricing: {
            id: 'pricing',
            title: 'Tel Aviv moving cost guide',
            intro: '',
    ...
    pianoMovePage: {
        ...
        pricing: {
            id: 'pricing',
            title: 'Piano moving cost guide',
            intro: '',
            tableLabel: 'Piano moving cost guide',
            tableHeaders: [],
            rows: [],
            afterTable: '',
        },
