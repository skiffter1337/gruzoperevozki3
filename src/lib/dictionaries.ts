        ...
        sliderItems: [
            {
                ...
                carrierRegion: null,
                cityLinks: [
                    {label: "Тель-Авив", slug: "perevozki-v-tel-avive"},
                    {label: "Рамат-Ган", slug: "perevozki-v-ramat-gane"},
                    {label: "Гиватаим", slug: "perevozki-v-givataime"},
                    {label: "Холон", slug: "perevozki-v-holone"},
                    {label: "Бат-Ям", slug: "perevozki-v-bat-yame"},
                ],
            },
            {
                title: "Равнина (Шарон)",
                ...
                cityLinks: [
                    {label: "Нетания", slug: "perevozki-v-netanii"},
                    {label: "Герцлия", slug: "perevozki-v-gertslii"},
                    {label: "Кфар-Саба", slug: "perevozki-v-kfar-sabe"},
                    {label: "Раанана", slug: "perevozki-v-raanane"},
                    {label: "Ход-ха-Шарон", slug: "perevozki-v-hod-ha-sharone"},
                ],
            },
            {
                title: "Низины (Шфела)",
                ...
                cityLinks: [
                    {label: "Ришон-ле-Цион", slug: "perevozki-v-rishon-le-tsione"},
                    {label: "Реховот", slug: "perevozki-v-rehovote"},
                    {label: "Рамла", slug: "perevozki-v-ramle"},
                    {label: "Лод", slug: "perevozki-v-lode"},
                    {label: "Ашдод", slug: "perevozki-v-ashdode"},
                ],
            },
            {
                ...
                cityLinks: [
                    {label: "Иерусалим", slug: "perevozki-v-ierusalime"},
                    {label: "Бейт-Шемеш", slug: "perevozki-v-beit-shemeshe"},
                    {label: "Маале-Адумим", slug: "perevozki-v-maale-adumime"},
                    {label: "Модиин", slug: "perevozki-v-modiine"},
                    {label: "Мевасерет-Цион", slug: "perevozki-v-mevaseret-tsione"},
                ],
            },
            {
                title: "Север",
            ...
            },
            {
                ...
                carrierRegion: "south",
                cityLinks: [
                    {label: "Беэр-Шева", slug: "perevozki-v-beer-sheve"},
                    {label: "Ашкелон", slug: "perevozki-v-ashkelone"},
                    {label: "Эйлат", slug: "perevozki-v-eilate"},
                    {label: "Димона", slug: "perevozki-v-dimone"},
                    {label: "Нетивот", slug: "perevozki-v-netivote"},
                ],
            },
        ],
    },
