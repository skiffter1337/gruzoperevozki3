...
const defaultDictionary: DictionaryType = {
    ...
    ashkelonMovePage: {
        ...
        pricing: {
            ...
            rows: [
                { type: "Перевозка одной вещи", priceRange: "249–450 ₪", notes: "Холодильник, диван, стиральная машина; зависит от этажности." },
                { type: "Перевозка 1-комнатной квартиры / студента", priceRange: "550–1 150 ₪", notes: "Часто заказывают для аренды и переездов в новые районы." },
                { type: "Перевозка 2-комнатной квартиры", priceRange: "1 100–1 950 ₪", notes: "Цена выше, если нет лифта или сложная парковка." },
                { type: "Перевозка 3-комнатной квартиры", priceRange: "1 950–3 200 ₪", notes: "Обычно включает базовую разборку/сборку." },
                { type: "Перевозка 4-комнатной квартиры", priceRange: "2 800–4 600 ₪", notes: "Рекомендуется предварительная оценка объёма." },
                { type: "Перевозка 5-комнатной квартиры / дома", priceRange: "4 000–6 800 ₪", notes: "Иногда требуется подъёмный кран (доплата)." },
